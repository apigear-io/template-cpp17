...
class custom_typesConan(ConanFile):
    name = "custom_types"
    version = "1.0.0"
    ...
    def layout(self):
        cmake_layout(self)
        self.folders.root = ".."
        self.folders.source = "custom_types"

    def export_sources(self):
        # move one level up from the recipe folder
        source_folder = os.path.join(self.recipe_folder, "..")
        # wrap sources into modules name
        dst_folder = os.path.join(self.export_sources_folder, "custom_types")
    ...
    def build(self):
        ...
        if self.folders.base_source.endswith("custom_types"):
    ...
    def package_info(self):
        # generates a Findcustom_types.cmake file in addition to the custom_types-config.cmake
