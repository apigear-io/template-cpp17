...
{
    subscribeTopic("tb.names.NamEs.set.Switch", [this](const auto& value){ onSetSwitch(value); });
    subscribeTopic("tb.names.NamEs.set.SOME_PROPERTY", [this](const auto& value){ onSetSomeProperty(value); });
...
{
    (void) SOME_PARAM;
    static const std::string topic = "tb.names.NamEs.sig.SOME_SIGNAL";
