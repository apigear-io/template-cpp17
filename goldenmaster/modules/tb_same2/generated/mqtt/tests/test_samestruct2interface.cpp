...
TEST_CASE("mqtt  tb.same2 SameStruct2Interface tests")
{
    ...
    auto clientSameStruct2Interface = std::make_shared<Test::TbSame2::MQTT::SameStruct2InterfaceClient>(mqttclient);
    auto implSameStruct2Interface= std::make_shared<Test::TbSame2::SameStruct2Interface>();
    auto serviceSameStruct2Interface = std::make_shared<Test::TbSame2::MQTT::SameStruct2InterfaceService>(implSameStruct2Interface, mqttservice);
