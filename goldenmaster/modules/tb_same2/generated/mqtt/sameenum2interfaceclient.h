...
namespace MQTT {
/**
 * @brief MQTT adapter for SameEnum2Interface.
 *
 ...
 */
class TEST_TB_SAME2_EXPORT SameEnum2InterfaceClient : public ISameEnum2Interface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
