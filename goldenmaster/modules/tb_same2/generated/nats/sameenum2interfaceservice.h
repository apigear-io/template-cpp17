...
namespace TbSame2 {
namespace Nats {
class TEST_TB_SAME2_EXPORT SameEnum2InterfaceService : public ISameEnum2InterfaceSubscriber, public ApiGear::Nats::BaseAdapter,  public std::enable_shared_from_this<SameEnum2InterfaceService>
{
protected:
