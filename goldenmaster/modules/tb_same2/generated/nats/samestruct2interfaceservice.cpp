...
void SameStruct2InterfaceService::onConnected()
{
    ...
    m_service->publish("tb.same2.SameStruct2Interface.prop.prop1", nlohmann::json(m_impl->getProp1()).dump());
    m_service->publish("tb.same2.SameStruct2Interface.prop.prop2", nlohmann::json(m_impl->getProp2()).dump());
}
