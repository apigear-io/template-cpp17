...
namespace TbSame2 {
namespace Nats {
class TEST_TB_SAME2_EXPORT SameEnum1InterfaceService : public ISameEnum1InterfaceSubscriber, public ApiGear::Nats::BaseAdapter,  public std::enable_shared_from_this<SameEnum1InterfaceService>
{
protected:
