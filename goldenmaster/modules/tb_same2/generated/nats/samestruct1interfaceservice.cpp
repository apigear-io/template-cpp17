...
void SameStruct1InterfaceService::init()
{
    if (m_initialized.exchange(true)) {
        AG_LOG_WARNING("init() called more than once on " "SameStruct1InterfaceService" ", ignoring");
        return;
    }
    std::weak_ptr<SameStruct1InterfaceService> weak_self = shared_from_this();
...
void SameStruct1InterfaceService::onConnected()
{
    ...
    { 
        ...
        const std::string topic = "tb.same2.SameStruct1Interface.service.available";
