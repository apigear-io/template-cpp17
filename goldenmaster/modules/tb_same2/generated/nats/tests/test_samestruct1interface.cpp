...
TEST_CASE("Nats  tb.same2 SameStruct1Interface tests")
{
    ...
    {
        [[maybe_unused]] auto result = clientSameStruct1Interface->func1(Struct1());
        // CHECK EFFECTS OF YOUR METHOD HERE
    }
    SECTION("Test method func1 async")
    {
        std::atomic<bool> finished = false;
        auto resultFuture = clientSameStruct1Interface->func1Async(Struct1());
