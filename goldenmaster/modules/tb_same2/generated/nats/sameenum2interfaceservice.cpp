...
{
    subscribeTopic("tb.same2.SameEnum2Interface.set.prop1", [this](const auto& value){ onSetProp1(value); });
    subscribeTopic("tb.same2.SameEnum2Interface.set.prop2", [this](const auto& value){ onSetProp2(value); });
    subscribeRequest("tb.same2.SameEnum2Interface.rpc.func1", [this](const auto& args){  return onInvokeFunc1(args); });
    subscribeRequest("tb.same2.SameEnum2Interface.rpc.func2", [this](const auto& args){  return onInvokeFunc2(args); });
    const std::string initRequestTopic = "tb.same2.SameEnum2Interface.init";
    ...
    m_service->publish("tb.same2.SameEnum2Interface.prop.prop1", nlohmann::json(m_impl->getProp1()).dump());
    m_service->publish("tb.same2.SameEnum2Interface.prop.prop2", nlohmann::json(m_impl->getProp2()).dump());
}
...
{
    (void) param1;
    static const std::string topic = "tb.same2.SameEnum2Interface.sig.sig1";
...
void SameEnum2InterfaceService::onSig2(Enum1Enum param1, Enum2Enum param2)
{
    (void) param1;
    (void) param2;
    static const std::string topic = "tb.same2.SameEnum2Interface.sig.sig2";
    nlohmann::json args = { param1, param2 };
    m_service->publish(topic, nlohmann::json(args).dump());
}
void SameEnum2InterfaceService::onProp1Changed(Enum1Enum prop1)
{
    static const std::string topic = "tb.same2.SameEnum2Interface.prop.prop1";
    m_service->publish(topic, nlohmann::json(prop1).dump());
}
void SameEnum2InterfaceService::onProp2Changed(Enum2Enum prop2)
{
    static const std::string topic = "tb.same2.SameEnum2Interface.prop.prop2";
