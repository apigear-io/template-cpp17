...
void SameEnum1InterfaceService::onConnected()
{
    ...
    m_service->publish("tb.same2.SameEnum1Interface.prop.prop1", nlohmann::json(m_impl->getProp1()).dump());
}
...
{
    (void) param1;
    static const std::string topic = "tb.same2.SameEnum1Interface.sig.sig1";
...
{
    static const std::string topic = "tb.same2.SameEnum1Interface.prop.prop1";
