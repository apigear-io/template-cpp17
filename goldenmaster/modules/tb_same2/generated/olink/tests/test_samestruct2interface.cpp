...
TEST_CASE("olink  tb.same2 SameStruct2Interface tests")
{
    ...
    auto clientSameStruct2Interface = std::make_shared<Test::TbSame2::olink::SameStruct2InterfaceClient>();
    ...
    auto serviceSameStruct2Interface = std::make_shared<Test::TbSame2::olink::SameStruct2InterfaceService>(implSameStruct2Interface, remote_registry);
