...
TEST_CASE("olink  tb.same2 SameEnum2Interface tests")
{
    ...
    auto clientSameEnum2Interface = std::make_shared<Test::TbSame2::olink::SameEnum2InterfaceClient>();
    ...
    auto serviceSameEnum2Interface = std::make_shared<Test::TbSame2::olink::SameEnum2InterfaceService>(implSameEnum2Interface, remote_registry);
