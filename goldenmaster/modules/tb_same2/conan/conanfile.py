...
class tb_same2Conan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["tb_same2-api"].requires = ["apigear::utilities",]
        ...
        self.cpp_info.components["tb_same2-implementation"].requires = ["tb_same2-core", "nlohmann_json::nlohmann_json", "apigear::utilities"]
