 ...
 * Property storage is not guarded by a mutex; wrap with SameEnum1InterfaceThreadSafeDecorator
 * for concurrent access from multiple threads.
 */
class TEST_TB_SAME1_EXPORT SameEnum1InterfaceClient : public ISameEnum1Interface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
    explicit SameEnum1InterfaceClient(std::shared_ptr<ApiGear::MQTT::Client> client);
    static std::shared_ptr<SameEnum1InterfaceClient> create(std::shared_ptr<ApiGear::MQTT::Client> client);
