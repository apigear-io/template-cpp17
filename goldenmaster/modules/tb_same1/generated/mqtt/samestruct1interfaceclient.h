...
namespace MQTT {
/**
 * @brief MQTT adapter for SameStruct1Interface.
 *
 ...
 */
class TEST_TB_SAME1_EXPORT SameStruct1InterfaceClient : public ISameStruct1Interface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
