...
public:
    ...
    * @return Promise of type Enum1Enum which is set once the function has completed
    */
    virtual std::future<Enum1Enum> func2Async(Enum1Enum param1, Enum2Enum param2, std::function<void(Enum1Enum)> callback = nullptr) = 0;
...
public:
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToProp1Changed(SameEnum2InterfaceProp1PropertyCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToProp2Changed(SameEnum2InterfaceProp2PropertyCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToSig1(SameEnum2InterfaceSig1SignalCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToSig2(SameEnum2InterfaceSig2SignalCb callback) = 0;
    /**
