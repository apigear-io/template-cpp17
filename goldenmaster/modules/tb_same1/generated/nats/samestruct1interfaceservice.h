...
namespace TbSame1 {
namespace Nats {
class TEST_TB_SAME1_EXPORT SameStruct1InterfaceService : public ISameStruct1InterfaceSubscriber, public ApiGear::Nats::BaseAdapter,  public std::enable_shared_from_this<SameStruct1InterfaceService>
{
protected:
