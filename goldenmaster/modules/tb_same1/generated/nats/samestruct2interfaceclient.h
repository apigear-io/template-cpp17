...
namespace TbSame1 {
namespace Nats {
class TEST_TB_SAME1_EXPORT SameStruct2InterfaceClient : public ISameStruct2Interface, public ApiGear::Nats::BaseAdapter,  public std::enable_shared_from_this<SameStruct2InterfaceClient>
{
protected:
