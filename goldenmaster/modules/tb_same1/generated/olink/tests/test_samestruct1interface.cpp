...
TEST_CASE("olink  tb.same1 SameStruct1Interface tests")
{
    ...
    auto clientSameStruct1Interface = std::make_shared<Test::TbSame1::olink::SameStruct1InterfaceClient>();
    ...
    auto serviceSameStruct1Interface = std::make_shared<Test::TbSame1::olink::SameStruct1InterfaceService>(implSameStruct1Interface, remote_registry);
