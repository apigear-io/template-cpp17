...
TEST_CASE("olink  tb.same1 SameEnum1Interface tests")
{
    ...
    auto clientSameEnum1Interface = std::make_shared<Test::TbSame1::olink::SameEnum1InterfaceClient>();
    ...
    auto serviceSameEnum1Interface = std::make_shared<Test::TbSame1::olink::SameEnum1InterfaceService>(implSameEnum1Interface, remote_registry);
