...
class tb_same1Conan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["tb_same1-nats"].includedirs.append(os.path.join(self.package_folder, "include"))
        self.cpp_info.components["tb_same1-nats"].libs = ["tb_same1-nats"]
        self.cpp_info.components["tb_same1-nats"].requires = ["tb_same1-core", "nlohmann_json::nlohmann_json", "apigear::nats"]
