...
namespace MQTT {
/**
 * @brief MQTT adapter for StructInterface.
 *
 ...
 * Property storage is not guarded by a mutex; wrap with StructInterfaceThreadSafeDecorator
...
public:
    ...
    static std::shared_ptr<StructInterfaceClient> create(std::shared_ptr<ApiGear::MQTT::Client> client);
