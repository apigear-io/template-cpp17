...
namespace MQTT {
/**
 * @brief MQTT adapter for NoSignalsInterface.
 *
 ...
 * Property storage is not guarded by a mutex; wrap with NoSignalsInterfaceThreadSafeDecorator
 * for concurrent access from multiple threads.
 */
class TEST_TB_SIMPLE_EXPORT NoSignalsInterfaceClient : public INoSignalsInterface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
