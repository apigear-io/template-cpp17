...
namespace MQTT {
/**
 * @brief MQTT adapter for SimpleArrayInterface.
 *
 ...
 * Property storage is not guarded by a mutex; wrap with SimpleArrayInterfaceThreadSafeDecorator
...
public:
    ...
    static std::shared_ptr<SimpleArrayInterfaceClient> create(std::shared_ptr<ApiGear::MQTT::Client> client);
