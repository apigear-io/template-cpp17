...
std::shared_ptr<SimpleInterfaceClient> SimpleInterfaceClient::create(std::shared_ptr<ApiGear::MQTT::Client> client)
{
    return std::make_shared<SimpleInterfaceClient>(client);
}
