...
namespace MQTT {
/**
 * @brief MQTT adapter for SimpleInterface.
 *
 ...
 * Property storage is not guarded by a mutex; wrap with SimpleInterfaceThreadSafeDecorator
 * for concurrent access from multiple threads.
 */
class TEST_TB_SIMPLE_EXPORT SimpleInterfaceClient : public ISimpleInterface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
    explicit SimpleInterfaceClient(std::shared_ptr<ApiGear::MQTT::Client> client);
    static std::shared_ptr<SimpleInterfaceClient> create(std::shared_ptr<ApiGear::MQTT::Client> client);
