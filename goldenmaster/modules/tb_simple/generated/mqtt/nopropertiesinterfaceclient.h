...
namespace MQTT {
/**
 * @brief MQTT adapter for NoPropertiesInterface.
 *
 ...
 */
class TEST_TB_SIMPLE_EXPORT NoPropertiesInterfaceClient : public INoPropertiesInterface, public ApiGear::MQTT::MqttBaseAdapter
{
public:
