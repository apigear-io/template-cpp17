...
public:
    ...
    * @return Promise of type NestedStruct1 which is set once the function has completed
    */
    virtual std::future<NestedStruct1> func2Async(const NestedStruct1& param1, const NestedStruct2& param2, std::function<void(NestedStruct1)> callback = nullptr) = 0;
    ...
    * @return Promise of type NestedStruct1 which is set once the function has completed
    */
    virtual std::future<NestedStruct1> func3Async(const NestedStruct1& param1, const NestedStruct2& param2, const NestedStruct3& param3, std::function<void(NestedStruct1)> callback = nullptr) = 0;
...
public:
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToProp1Changed(NestedStruct3InterfaceProp1PropertyCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToProp2Changed(NestedStruct3InterfaceProp2PropertyCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToProp3Changed(NestedStruct3InterfaceProp3PropertyCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToSig1(NestedStruct3InterfaceSig1SignalCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToSig2(NestedStruct3InterfaceSig2SignalCb callback) = 0;
    /**
    ...
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual uint64_t subscribeToSig3(NestedStruct3InterfaceSig3SignalCb callback) = 0;
    /**
