...
TEST_CASE("Nats  testbed2 NestedStruct3Interface tests")
{
    ...
    SECTION("Test emit sig2")
    {
        ...
        auto local_param1_struct = NestedStruct1();
        Testbed2::fillTestNestedStruct1(local_param1_struct);
        auto local_param2_struct = NestedStruct2();
        Testbed2::fillTestNestedStruct2(local_param2_struct);

        clientNestedStruct3Interface->_getPublisher().subscribeToSig2(
        [&m_wait, &issig2Emitted, &local_param1_struct, &local_param2_struct](const NestedStruct1& param1, const NestedStruct2& param2)
        {
            REQUIRE(param1 ==local_param1_struct);
    ...
    SECTION("Test emit sig3")
    {
        ...
        auto local_param2_struct = NestedStruct2();
        Testbed2::fillTestNestedStruct2(local_param2_struct);
        auto local_param3_struct = NestedStruct3();
        Testbed2::fillTestNestedStruct3(local_param3_struct);

        clientNestedStruct3Interface->_getPublisher().subscribeToSig3(
        [&m_wait, &issig3Emitted, &local_param1_struct, &local_param2_struct, &local_param3_struct](const NestedStruct1& param1, const NestedStruct2& param2, const NestedStruct3& param3)
        {
            REQUIRE(param1 ==local_param1_struct);
            REQUIRE(param2 ==local_param2_struct);
    ...
    {
        [[maybe_unused]] auto result = clientNestedStruct3Interface->func1(NestedStruct1());
        // CHECK EFFECTS OF YOUR METHOD HERE
    }
    SECTION("Test method func1 async")
    {
        std::atomic<bool> finished = false;
        auto resultFuture = clientNestedStruct3Interface->func1Async(NestedStruct1());
        auto f = std::async(std::launch::async, [&finished, &resultFuture, &m_wait]() {resultFuture.wait(); finished = true; m_wait.notify_all();});
        lock.lock();
        REQUIRE( m_wait.wait_for(lock, std::chrono::milliseconds(timeout), [&finished](){ return finished == true; }));
        lock.unlock();
        auto return_value = resultFuture.get();
        REQUIRE(return_value == NestedStruct1()); 
        // CHECK EFFECTS OF YOUR METHOD HERE
    }
    SECTION("Test method func2")
    {
        [[maybe_unused]] auto result = clientNestedStruct3Interface->func2(NestedStruct1(), NestedStruct2());
        // CHECK EFFECTS OF YOUR METHOD HERE
    }
    SECTION("Test method func2 async")
    {
        std::atomic<bool> finished = false;
        auto resultFuture = clientNestedStruct3Interface->func2Async(NestedStruct1(), NestedStruct2());
        auto f = std::async(std::launch::async, [&finished, &resultFuture, &m_wait]() {resultFuture.wait(); finished = true; m_wait.notify_all();});
        lock.lock();
        REQUIRE( m_wait.wait_for(lock, std::chrono::milliseconds(timeout), [&finished](){ return finished == true; }));
        lock.unlock();
    ...
    {
        [[maybe_unused]] auto result = clientNestedStruct3Interface->func3(NestedStruct1(), NestedStruct2(), NestedStruct3());
        // CHECK EFFECTS OF YOUR METHOD HERE
    }
    SECTION("Test method func3 async")
    {
        std::atomic<bool> finished = false;
        auto resultFuture = clientNestedStruct3Interface->func3Async(NestedStruct1(), NestedStruct2(), NestedStruct3());
        auto f = std::async(std::launch::async, [&finished, &resultFuture, &m_wait]() {resultFuture.wait(); finished = true; m_wait.notify_all();});
        lock.lock();
        REQUIRE( m_wait.wait_for(lock, std::chrono::milliseconds(timeout), [&finished](){ return finished == true; }));
        lock.unlock();
