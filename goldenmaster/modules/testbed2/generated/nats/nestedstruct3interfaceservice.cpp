...
void NestedStruct3InterfaceService::init()
{
    if (m_initialized.exchange(true)) {
        AG_LOG_WARNING("init() called more than once on " "NestedStruct3InterfaceService" ", ignoring");
        return;
    }
    std::weak_ptr<NestedStruct3InterfaceService> weak_self = shared_from_this();
...
void NestedStruct3InterfaceService::onConnected()
{
    ...
    { 
        ...
        const std::string topic = "testbed2.NestedStruct3Interface.service.available";
