...
TEST_CASE("mqtt  testbed2 NestedStruct2Interface tests")
{
    ...
    SECTION("Test emit sig1")
    {
        ...
        lock.unlock();
        std::cout<<"TEST ENDED, disconnect will be performed NestedStruct2Interface Test emit sig1" << std::endl;
    }
    SECTION("Test emit sig2")
    {
        ...
        lock.unlock();
        std::cout<<"TEST ENDED, disconnect will be performed NestedStruct2Interface Test emit sig2" << std::endl;
    }
