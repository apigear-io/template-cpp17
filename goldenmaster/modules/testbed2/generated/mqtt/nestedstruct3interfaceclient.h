...
namespace MQTT {
/**
 * @brief MQTT adapter for NestedStruct3Interface.
 *
 ...
 * Property storage is not guarded by a mutex; wrap with NestedStruct3InterfaceThreadSafeDecorator
...
public:
    ...
    static std::shared_ptr<NestedStruct3InterfaceClient> create(std::shared_ptr<ApiGear::MQTT::Client> client);
